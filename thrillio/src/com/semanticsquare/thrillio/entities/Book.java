...
public class Book extends Bookmark implements Shareable {
    ...
    // this fun will help to send the data in xml format
    @Override
    public String getItemData() {
        ...
        builder.append("<item>");
            ...
            // StringUtils will only work when you include Apache commons lang jar file in dependencies of Modules
            // which you need to download from your webserver
